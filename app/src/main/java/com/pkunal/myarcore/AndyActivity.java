...
public class AndyActivity extends AppCompatActivity {
    ...
    private static final String TAG = AndyActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arFragment = (ArFragment) getSupportFragmentManager().findFragmentById(R.id.ux_fragment_andy);
